...
*/
function compoundInterest(initialBalance, annualIntRate, numYears) {
  return initialBalance * (Math.E ** (annualIntRate*numYears));
}
// console.log(compoundInterest(100, .04, 6));
